...
| **Auth scoped via nested `me` / user associations** | First-class — directives + context + lookahead includes                                                                                                | Possible but not the default product model                                 | Not applicable                                                                                    | Not applicable                                                                                  | You implement entirely                |
