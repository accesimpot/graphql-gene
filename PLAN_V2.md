...
| **Federation- and gateway-ready subgraphs**           | Gene-built schemas should work as **subgraphs** behind **Apollo Federation** and typical **gateway / managed graph** setups (e.g. **Hive**). **Integration tests** should confirm that (see §6).                                                                                                                                                                                                                                                                                                                                  |
...
- **Federation and gateways (Apollo, Hive, etc.):** v2 should **confirm** Gene works as a **subgraph** in **Apollo Federation**-style and **gateway / managed-graph** setups (including paths like **Hive**). The plan does not spell out how to build those tests; **integration tests** in the repo are the checkpoint.
...
- **Federation / gateway (§6):** Federation version, CI toolchain (e.g. Router vs Hive path), test layout in the repo.
